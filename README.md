...
| **BHYT hợp lệ**  | `123456789012345` (Nguyễn Thị Lan)         |
| **BHYT hợp lệ**  | `987654321098765` (Trần Văn Bảo)           |
| **BHYT hết hạn** | `111222333444555` (Lê Minh Châu – hết hạn) |
...
- [ ] Nhập BHYT hết hạn (`111222333444555`) → "Thẻ BHYT đã hết hạn"
